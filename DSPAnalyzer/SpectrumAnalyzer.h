...
- (void)processAudioInput:(id)handler allChannels:(BOOL)allChannels;
- (void)processAudioInput:(id)handler channel:(NSUInteger)channel;
- (void)processAudioInput:(id)handler channel1:(NSUInteger)channel1 channel2:(NSUInteger)channel2;
